...
const privateKey: Address = `0x${"c50d3eaed4263e8ad7a32a36708b4d359b391bcd2624577ab0267dd6055b7b92"}`;
...
export const RPCProviderUrl =
  process.env.RPC_PROVIDER_URL || "https://testnet.storyrpc.io";
...
export const CurrencyAddress: Address =
  (process.env.CURRENCY_ADDRESS as Address) ||

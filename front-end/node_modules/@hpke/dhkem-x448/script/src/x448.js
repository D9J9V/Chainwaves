(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@noble/curves/ed448", "@hpke/common"], factory);
    }
        ...
        _importJWK(key, isPublic) {
            return new Promise((resolve, reject) => {
                ...
                if (isPublic) {
                    ...
                    resolve(new common_1.XCryptoKey(ALG_NAME, base64UrlToBytes(key.x), "public"));
                }
                else {
                    if (typeof key.d !== "string") {
                        reject(new Error("Invalid key: `d` not found"));
                    }
                    resolve(new common_1.XCryptoKey(ALG_NAME, base64UrlToBytes(key.d), "private", common_1.KEM_USAGES));
                }
            });
        }
        _derivePublicKey(k) {
